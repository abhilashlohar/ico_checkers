...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2019 at 06:50 PM
...
CREATE TABLE `tasks` (
  ...
  `minimum_point` tinyint(10) DEFAULT NULL,
...
INSERT INTO `task_proofs` (`id`, `user_id`, `message`, `image`, `task_id`, `is_approved`) VALUES
(4, 6, 'hiii', 'task_proof\\chrysanthemum (1).jpg', 2, 1);
...
(11, 'manoj', 'manoj', 'manojtanwar953@gmail.com', 'User', '0989786756', '$2y$10$z0/NdkmXZ0d5JQ0U01WLq.jdCdTsSS0L.CyX8frRHIQyNCbp3vTku', 1, 0, NULL, NULL, NULL, 0, NULL, NULL, '2019-04-07 07:32:23', '2019-04-07 07:32:55');
