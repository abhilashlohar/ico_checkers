        		...
        		if ($this->Users->save($user)) {
		        	// Refer code
			          ...
			          if ($RefByUser) {
			          	...
			          	$meta_description = json_encode(['reason'=>'Referred a user for sign-up on icocheckers.']);
			          	$this->manageWallet(
			          		$RefByUser->id, 
			          		$MDICoins['refer'], 
			          		'Refer-and-Earn', 
			      	...
			      	// Wallet - Sign-up
	          	$meta_description = json_encode(['reason'=>'Sign-up bonus.']);
	          	$this->manageWallet(
	          		$user->id, 
	          		$MDICoins['sign_up'], 
	          		'Sign-up', 
