	...
	<div class="wrapper">
				...
				<div class="row about__first-row">
					...
					<div class="col-lg-5" data-aos="fade-right">
						<div class="block-header">
							...
							<h2 class="title title--black title--medium">Cryptoland Theme
					...
					<div class="col-xl-3 col-md-6">
						<div class="service__item" data-aos="fade-up">
							<div class="service__item-content">
								...
								<h3 class="service__item-title">Cryptoland App</h3>
								<p>
					...
					<div class="col-lg-5 col-md-8" data-aos="fade-right" >
						<div class="block-header block-header--animated">
							...
							<h2 class="title title--black title--medium">
								Cryptoland App for ICO Platform
							</h2>
						</div>
				...
				<div class="row">
					<div class="col-lg-6 offset-lg-6" data-aos="fade-left" >
						...
						<ul class="token__info-list">
							<li>
								<span>Name:</span> Cryptoland Token
							</li>
							<li>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col">
						© 2018, Cryptoland Theme by Artureanec
					</div>
				</div>
			</div>
		</div>
